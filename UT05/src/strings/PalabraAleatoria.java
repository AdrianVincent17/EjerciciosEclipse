...
public class PalabraAleatoria {
	...
	private static String generarPalabras() {
		String[] array = { "AUSTRALOPITECUS", "PIZARRA", "LINFOCITO", "GERIFALTE", "EPITAFIO", "EMPANADILLA",
				"MATASUEGRAS", "DROMEDARIO", "CORONAVIRUS", "TESTAMENTO", "ORDENAMIENTO", "ANTICAPITALISMO",
				"FONTANERO", "BUTANERO", };
