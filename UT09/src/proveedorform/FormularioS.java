...
public class FormularioS extends JFrame implements ActionListener {
	...
	private JLabel nueva, listado, cod, nom, est, ciud;
	...
	public FormularioS() {
		...
		nom.setBounds(220,60,60,25);
		add(nom);
		
		nombre=new JTextField();
		nombre.setBounds(280,60,100,25);
		add(nombre);
		
		est=new JLabel("Estado: ");
		est.setBounds(30,100,60,25);
		add(est);
		
		estado=new JTextField();
		estado.setBounds(90,100,100,25);
		add(estado);
		
		ciud=new JLabel("Ciudad: ");
		ciud.setBounds(220,100,60,25);
		add(ciud);
		
		ciudad=new JTextField();
		ciudad.setBounds(280,100,100,25);
		add(ciudad);
	...
	public static void main(String[] args) {
		...
		FormularioS fo=new FormularioS();
		
		fo.setVisible(true);
		fo.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		fo.setTitle("PROVEEDOR");
		fo.setSize(450,420);
